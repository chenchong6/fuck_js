...
document.__proto__ = {'body':'<html><body></body></html>'};
window.navigator = navigator = {
    ...
    plugins:[{'name':'pdf','filename':'internal-pdf-viewer'},{'name':'Chrome PDF Viewer','filename':'internal-pdf-viewer'},{'name':'pdf','filename':'WebKit built-in PDF'},{'name':'pdf','filename':'internal-pdf-viewer'},{'name':'pdf','filename':'internal-pdf-viewer'},],

};
navigator.__proto__ = {'languages':['zh','zh-CN']};
...
window['top']['0'] = Object.assign({}, window);
window['name']='zhipinFrame';
parent= window;
Buffer = undefined;
window = global;
window.self = window;
process.argv = undefined;
self = window.self =window =global.self =global;

function get_zp_token(seed,ts,namejs){
    require(namejs)
    var code = new ABC().z(seed,parseInt(ts));
    return code;
};
